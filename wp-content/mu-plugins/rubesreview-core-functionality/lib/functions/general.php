...
function cws_home_featured() {
	...
	genesis_widget_area ('spotlight-widget', array(
		'before' => '<div class="flexible-widgets widget-area spotlight-widget' . custom_widget_area_class( 'spotlight-widget' ) . '"><div class="wrap">',
        'after'  => '</div></div>',
	) );

	genesis_widget_area ('spotlight-cta-widget', array(
        'before' => '<div class="spotlight-cta-widget"><div class="wrap">',
        'after' => '</div></div>',
	) );
}

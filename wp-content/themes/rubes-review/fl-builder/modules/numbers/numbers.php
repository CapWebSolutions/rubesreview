...
/**
 * @class INMFLNumbersModule
 */
class INMFLNumbersModule extends FLBuilderModule {
	...
	public function render_number(){
		...
		$data_number = $this->settings->inm_shortcode; 
 ...
 */
FLBuilder::register_module('INMFLNumbersModule', array(
	'general'       => array( // Tab
		...
		'sections'      => array( // Tab Sections
			'general'       => array( // Section
				...
				'fields'        => array( // Section Fields
					...
					'number_source' => array(
					    'type'          => 'select',
					    'label'         => __( 'Number Source', 'fl-builder' ),
					    'default'       => 'percent',
					    'options'       => array(
					...
					'inm_shortcode' => array(
						...
						'placeholder'	=> '',
						'connections'   => array( 'custom_field' ),
						'help'			=> __( 'Add a shortcode here that generates a number dynamically.', 'fl-builder' ),
					),
					'max_number' => array(
						'type'          => 'text',

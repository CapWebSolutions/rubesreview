 ...
 *
 * This file adds the Ratings Leaderboard PODS based page template to the Rube's Review Theme.
 *
 * Template Name: Ratings PODS Ldrbrd
	...
	switch ( $rating_display_value ) {
				...
				printf('<div class="ratings-top5-grouping">');
					if ( $wp_query -> have_posts() ) {
						...
						while ( $wp_query -> have_posts() ) {
							...
							echo do_shortcode( $pod->template( 'Ratings Page Agency' ) );
		...
		foreach ( $orgtypes as $orgvalue ) {
			...
			$params = array( 
				...
				'page' => 2,
				'orderby' => 'post_date',  
				'where'=>"eval_org_type = 'My Category'" 
			); 

...
function rubesreview_evaluation_hospital_info() {
	...
	$evaluation_meta = array(
		...
		'recruiting_contact' => get_post_meta( $post_id,  $prefix . 'overall_satisfaction', true ),
		'recruiting_contact_polite' => get_post_meta( $post_id,  $prefix . 'recruiting_contact', true ),
		...
		'happy_pay_offered' => get_post_meta( $post_id,  $prefix . 'overall_satisfaction', true ),
		'happy_change_schedule' => get_post_meta( $post_id,  $prefix . 'happy_pay_offered', true ),
		...
		'communicate_w_superiors' => get_post_meta( $post_id,  $prefix . 'training_adequate', true ),

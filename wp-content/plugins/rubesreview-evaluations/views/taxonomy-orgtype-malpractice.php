<?php
/**
 * Evaluation Post Type: Malpractice Taxonomy View
 *
...
add_action( 'genesis_entry_header', 'rubesreview_evaluation_malpractice_info', 10 );
function rubesreview_evaluation_malpractice_info( $evaluation_meta ) {

	global $post;

	FLBuilder::render_query( array(
		'post_type' => 'fl-builder-template',
		'p'         => 956 // Breaver Header Taxonomy Template ID
	) );
...
/* Need to get all the evaluation posts with tax = 'malpracticecontinuing educqtion'
- loop through all those posts
- pull off appropriate meta fields based on orgtype - each will be unique
- display each piece of meta
- paginate as needed
- end loop
